    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-success/5 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-primary">Affordify</CardTitle>
          <CardDescription>
          ...
          <Tabs defaultValue="login" className="space-y-4">
            ...
            <TabsContent value="login" className="space-y-4">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-primary to-primary-light">
                  Login
                </Button>
              </form>
            </TabsContent>
            ...
            <TabsContent value="signup" className="space-y-4">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-to-r from-success to-info">
                  Sign Up
                </Button>
              </form>
            </TabsContent>
